...
export class AdministradorService {
  ...
  async create(createAdministradorDto: AdministradorDto): Promise<Administrador> {
  ...
  async update(id: number, updateAdministradorDto: AdministradorDto): Promise<UpdateResult> {
